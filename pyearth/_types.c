...
#define __pyx_n_u_FLOAT __pyx_string_tab[4]
#define __pyx_n_u_INDEX __pyx_string_tab[5]
#define __pyx_n_u_INT __pyx_string_tab[6]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[7]
#define __pyx_n_u_float64 __pyx_string_tab[8]
#define __pyx_n_u_int64 __pyx_string_tab[9]
#define __pyx_n_u_intp __pyx_string_tab[10]
...
#define __pyx_n_u_np __pyx_string_tab[14]
#define __pyx_n_u_numpy __pyx_string_tab[15]
...
#define __pyx_n_u_uint8 __pyx_string_tab[19]
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "_types" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit__types", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "pyearth._types")) {
      if (unlikely((PyDict_SetItemString(modules, "pyearth._types", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * INDEX = np.intp
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_float64); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_FLOAT, __pyx_t_3) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 * BOOL = np.uint8
*/
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_int64); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_INT, __pyx_t_2) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * BOOL = np.uint8
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_intp); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_INDEX, __pyx_t_3) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 * BOOL = np.uint8             # <<<<<<<<<<<<<<
*/
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_uint8); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_BOOL, __pyx_t_2) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{39},{34},{4},{5},{5},{3},{18},{7},{5},{4},{8},{10},{8},{2},{5},{12},{10},{8},{5}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (177 bytes) */
const char* const cstring = "BZh91AY&SY\2518\272@\000\000\010\337\200@\000@\001\005@\267%\204@\277o\376  \000\204\022\240M'\242h\323\324\323\315H\006\320\320h\230I4\364C\310\206 0\"g_\346c\017%\306\352\347&J2\232>hX\331\316\t\334V\230\321q^\"\014z\207\257o\237\215j\362\236\235e\260\320K\306\230ry\264\013\365i\366\332\320\273w\035\007\013\302\255f|\3411\007\232\210\232\r\\!_\000\234\240\346[K\311\206\244\202\205\242\220\251.\274Zah\221\r]\314\356\255A\026\334\373\306SrKK\201w$S\205\t\n\223\213\244\000";
    ...
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (146 bytes) */
const char* const cstring = "x\332eN1\016\3020\014\374J^\320\t!6\004\002\244JU\263t`\263L\342\210\2108ISg\350\357\ttA\302\303\371\344;\371\356\030+\347\265\003\223\nu\\\203x,\005W\345\320\007\262J\222\362\234S\221_[e\224\347\237\343\254\365p\033\364i\352\307\313\365\336\217\223\t>\022\370\010R\320\320\003\315\313\205\204\262\337\371\270A\006`lz\033N\266\006\372\260\210\334v\314\337@\200\271b\330N\013\211%\207\255\"\200\320\322\260\266\037\2077\256#J*";
    PyObject *data = __Pyx_DecompressString(cstring, 146, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
...
const char* const bytes = "?numpy._core.multiarray failed to importnumpy._core.umath failed to importBOOLFLOATINDEXINTcline_in_tracebackfloat64int64intp__main____module____name__npnumpy__qualname__setdefault__test__uint8";
    PyObject *data = NULL;
